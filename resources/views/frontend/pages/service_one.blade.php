    ...
    <div class="page-title__area pt-110" style="background-image: url({{ asset('fontend') }}/img/about-us/ab-us.jpg);">
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper text-center">
                        <h3 class="pb-100">Visa Consultancy</h3>
                    </div>
                </div>
            </div>
        </div>
        <nav class="breadccrumb-bg">
            <ul class="breadcrumb justify-content-center pt-20 pb-20">
                ...
                <li class="bd-items"> <a href="{{ route('frontend.service_one') }}">Visa Consultancy</a></li>
            </ul>
        </nav>
    </div>
    <!-- page title area end -->
                    ...
                    <div class="col-xxl-8 col-xl-8 col-lg-8">
                        <div class="sidebar__deatils">
                            <div class="visa-details">
                                ...
                                <p class="mb-30">Applying for a visa and coming out successful with a visa is tougher than
                                    it looks. Due to illegal migration practices, Immigration authorities around the world
                                    are extra-careful to assess a traveler’s profile based on the documents she/he provides.
                                </p>
                                <p class="mb-35">Consequently, your purpose of travel, your financial capabilities and
                                    your personal, social and professional profiles must be displayed in a balanced order in
                                    the application package.ST International Travels Agency service guides a visa seeker
                                    throughout the visa processing journey. </p>
                                    ...
                                    <div class="col-xxl-6 col-xl-6">
                                        <div class="necessary__box">
                                            ...
                                            <ul class="necessary-link mb-20">
                                                <li><i class="fal fa-check-square"></i> Purchasing Consultancy Service.</li>
                                                <li><i class="fal fa-check-square"></i> Consultancy Session</li>
                                                <li><i class="fal fa-check-square"></i> Case Assessment and Customized Checklist
                                                </li>
                                                <li><i class="fal fa-check-square"></i> Document Processing</li>
                                                <li><i class="fal fa-check-square"></i> Case Delivery </li>
