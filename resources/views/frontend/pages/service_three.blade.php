    ...
    <div class="page-title__area pt-110" style="background-image: url({{ asset('fontend') }}/img/about-us/ab-us.jpg);">
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper text-center">
                        <h3 class="pb-100">One Way Collection</h3>
                    </div>
                </div>
            </div>
        </div>
        <nav class="breadccrumb-bg">
            <ul class="breadcrumb justify-content-center pt-20 pb-20">
                ...
                <li class="bd-items"> <a href="{{ route('frontend.service_three') }}">One Way Collection</a></li>
            </ul>
        </nav>
    </div>
    <!-- page title area end -->
                    ...
                    <div class="col-xxl-8 col-xl-8 col-lg-8">
                        <div class="sidebar__deatils">
                            <div class="visa-details">
                                ...
                                <p class="mb-30">Do you need to collect your documents or passport from a consular office
                                    abroad? We’ll be able to help you collect the documents as your authorized
                                    representative from the designated embassy/visa center in India. You don’t have to
                                    travel in person for the collection. We’ll take care of all the issues and keep you
                                    updated about the step-by-step processes until you get your desired visa.
                                </p>
