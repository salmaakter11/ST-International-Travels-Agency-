    ...
    <div class="page-title__area pt-110" style="background-image: url({{ asset('fontend') }}/img/about-us/ab-us.jpg);">
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper text-center">
                        <h3 class="pb-100">Document Legalization</h3>
                    </div>
                </div>
            </div>
        </div>
        <nav class="breadccrumb-bg">
            <ul class="breadcrumb justify-content-center pt-20 pb-20">
                ...
                <li class="bd-items"> <a href="{{ route('frontend.service_four') }}">Document Legalization</a></li>
            </ul>
        </nav>
    </div>
    <!-- page title area end -->
                            ...
                            <div class="sidebar__widget mb-30">
                                <div class="sidebar__widget-content">
                                    <div class="sidebar__widget-content-banner">
                                        <img src="{{ asset('fontend') }}/img/business-visa/business-adds.jpg" alt="">
                    ...
                    <div class="col-xxl-8 col-xl-8 col-lg-8">
                        <div class="sidebar__deatils">
                            <div class="visa-details">
                                ...
                                <p class="mb-30">An applicant should apply at center in or closest to, the city in which
                                    you are documented as being a resident. Please contact VFS Global if you have any doubts
                                    as to where to make your application. Applicants are permitted to bring somebody to
                                    assist them but limited to 1 person per applicant or group. VFS Global will not allow.
                                </p>
                                <p class="mb-35">Issuance of the immigrant visa to the intending immigrant. Before the
                                    immigrant visa expires, the intended immigrant must show the immigrant visa at a U.S.
                                    port-of-entry. When an immigrant's immigrant visa is approved, he or she becomes a
                                    lawful for Individuals and circumstances influence how long.</p>
                                <h3 class="visa-deatils__title mb-25">
                                    Visa Application Whole Process
                                </h3>
                                <p class="mb-35">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iusto, quae
                                ...
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-6">
                                        <div class="necessary__box-thumb">
                                            <img src="{{ asset('fontend') }}/img/business-visa/business-1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xxl-6 col-xl-6">
                                        <div class="necessary__box">
                                            ...
                                            <ul class="necessary-link mb-20">
                                                ...
                                                <li><i class="fal fa-check-square"></i> Round trip reservation or itinerary
                                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-6">
                                        <div class="information-right">
                                            <img src="{{ asset('fontend') }}/img/business-visa/bussiness-2.jpg" alt="">
