    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Procesed List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="">Procesed List</a></li>
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{route('admin.procesed_search_print')}}" target="_blank" method="post" id="submit_client_contact_form"
                                        autocomplete="off">
                                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.procesed_list_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        let pendingData = async (res) => {
            ...
            if (res.invoice.length != 0) {
                ...
                $.each(res.invoice, function(key, value) {
                    ...
                    let procesed_details_print = "{{ route('admin.procesed_details_print', ':id') }}";
                    procesed_details_print = procesed_details_print.replace(':id', id);
                    let procesed_details = "{{ route('admin.procesed_details', ':id') }}";
                    procesed_details = procesed_details.replace(':id', id);
                    let procesed_process = "{{ route('admin.procesed_process', ':id') }}";
                    procesed_process = procesed_process.replace(':id', id);
                    ...
                    data += `
                            <tr>
                                ...
                                <td scope="col" class="text-center"><span class='bg-primary px-1 rounded'>Procesed</span></td>
                                <td scope="col" class="text-center">${ value.created_name.name && value.created_name.name  !=null ?value.created_name.name : ''}</td>

                                <td scope="col" class="text-center">
                                    <a target="_blank" href="${procesed_details_print}" class="btn-sm btn-warning">Print</a>&nbsp;
                                    <a href="${procesed_details}" class="btn-sm btn-secondary"><i class="fas fa-eye mt-3"></i></a> <br><br>
                                    <a href="${procesed_process}" class="btn-sm btn-primary pending_process">Finalized</a>
        ...
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.procesed_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
