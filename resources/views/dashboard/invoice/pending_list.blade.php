                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="">Pending List</a></li>
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.pending_search_print') }}" target="_blank" method="post"
                                        id="submit_client_contact_form" autocomplete="off">
                                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.pending_list_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        let pendingData = async (res) => {
            ...
            if (res.invoice.length != 0) {
                ...
                $.each(res.invoice, function(key, value) {
                    ...
                    let pending_details_print = "{{ route('admin.pending_details_print', ':id') }}";
                    pending_details_print = pending_details_print.replace(':id', id);
                    let pending_details = "{{ route('admin.pending_details', ':id') }}";
                    pending_details = pending_details.replace(':id', id);
                    let pending_process = "{{ route('admin.pending_process', ':id') }}";
                    pending_process = pending_process.replace(':id', id);
                    ...
                    data += `
                            <tr>
                                ...
                                <td scope="col" class="text-center"><span class='bg-warning px-1 rounded'>Pending</span></td>
                                <td scope="col" class="text-center">${ value.created_name.name && value.created_name.name  !=null ?value.created_name.name : ''}</td>

                                <td scope="col" class="text-center">
                                    <a target="_blank" href="${pending_details_print}" class="btn-sm btn-warning">Print</a>&nbsp;
                                    <a href="${pending_details}" class="btn-sm btn-secondary"><i class="fas fa-eye mt-3"></i></a> <br><br>
                                    <a href="${pending_process}" class="btn-sm btn-primary pending_process">Processing</a>
        ...
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.pending_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
