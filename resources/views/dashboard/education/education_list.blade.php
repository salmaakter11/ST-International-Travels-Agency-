    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Education Level List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('admin.education_create') }}">Add New Education Level </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @if (isset($education_level))
                                            @foreach ($education_level as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-left">{{ $data->level_name }}</td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                        @else
                                                    ...
                                                    <a href="{{ route('admin.education_delete', $data->id) }}" class="delete_data btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>&nbsp;
                                                        <a href="{{ route('admin.education_edit', $data->id) }}" class="btn-sm btn-info"><i class="fas fa-edit text-light"></i> </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
