    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Result Type List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('admin.result_create') }}">Add New Result Type </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <table class="table table-bordered border-secondary datatable">
                                    ...
                                    <tbody>
                                        @if (isset($result_type))
                                            @foreach ($result_type as $key => $data)
                                                <tr>
                                                    <td scope="col" class="text-center">{{ $key + 1 }}</td>
                                                    <td scope="col" class="text-left">{{ $data->result_type }}</td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                        @else
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                        ...
                                                        <a href="{{ route('admin.result_delete', $data->id) }}" class="delete_data btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>&nbsp;
                                                        <a href="{{ route('admin.result_edit', $data->id) }}" class="btn-sm btn-info"><i class="fas fa-edit text-light"></i> </a>
